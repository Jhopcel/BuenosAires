...
def poblar_bd(request):
    ...
    try:
        ...
        # Producto.objects.create(idprod="ALAN67", marca='Volvo', modelo="Volvo Station Wagon", imagen="images/volvosw.jpg", precio=700000000, categoria=Categoria.objects.get(idCategoria=2))
        # Producto.objects.create(idprod="BILL88", marca='Saleen', modelo="S7", imagen="images/saleen.jpg", precio=600000000, categoria=Categoria.objects.get(idCategoria=2))
        # Producto.objects.create(idprod="ELVI54", marca='Shelby', modelo="Cobra de 1967", imagen="images/cobra.jpg", precio=600000000, categoria=Categoria.objects.get(idCategoria=2))
        # Producto.objects.create(idprod="FEDE84", marca='Mercedes-Benz', modelo="Pagoda de 1972", imagen="images/pagoda.jpg", precio=800000000, categoria=Categoria.objects.get(idCategoria=2))
        # Producto.objects.create(idprod="JEFF46", marca='Ford', modelo="Wolf WR1 Ford Race Car", imagen="images/wolf.jpg", precio=700000000, categoria=Categoria.objects.get(idCategoria=2))
        # Producto.objects.create(idprod="JOHN80", marca='Ford', modelo="Flathead Roadster de 1932", imagen="images/flathead.jpg", precio=600000000, categoria=Categoria.objects.get(idCategoria=2))
        # Producto.objects.create(idprod="PAUL62", marca='Rolls-Royce', modelo="Phantom", imagen="images/phantom.jpg", precio=500000000, categoria=Categoria.objects.get(idCategoria=2))
        # Producto.objects.create(idprod="SCAR47", marca='Mustang', modelo="Mustang de 1970", imagen="images/mustang.jpg", precio=400000000, categoria=Categoria.objects.get(idCategoria=2))
        # Producto.objects.create(idprod="TIRO98", marca='Mercedes-Benz', modelo="Iron Bike de 1998", imagen="images/motoiron.jpg", precio=300000000, categoria=Categoria.objects.get(idCategoria=3))
        # Producto.objects.create(idprod="UVAM20", marca='Silver Plus', modelo="Silver de 2000", imagen="images/silver.jpg", precio=200000000, categoria=Categoria.objects.get(idCategoria=3))
