...
from .views import perfil_usuario, iniciar_pago, pago_exitoso, solicitud_servicio, iniciar_pagosol
...
urlpatterns = [
    ...
    path('iniciar_pago_sol/<id>', iniciar_pagosol, name="iniciar_pago_sol"),
